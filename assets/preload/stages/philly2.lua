function onCreate()
	makeLuaSprite('sky','philly/sky', -100, 00);
	scaleObject('sky', 2.0, 2.0);
	setLuaSpriteScrollFactor('sky', 0.1, 0.1);

	makeLuaSprite('city','philly/city',-20,-10);
	setLuaSpriteScrollFactor('city', 0.3, 0.3);
	scaleObject('city', 1.7, 1.7);

	makeLuaSprite('behindTrain','philly/behindTrain',50,80);
	...
	makeAnimatedLuaSprite('Crowd2DARK','philly/Crowd1',30,320);
	addAnimationByPrefix('Crowd2DARK','idle','Crowd1 instance 1',24,false);
